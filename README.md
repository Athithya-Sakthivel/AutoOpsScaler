...
│   └── workflows/
│       └── ci.yml                              # CI pipeline: lint (ruff, pylint, mypy), tests (pytest, services), build devcontainer image, optional Flyte registration
│
...
│   │   ├── EL_flyte_workflow_v1.yml            # Example generated Flyte workflow spec (optional)
│   │   └── EL_flyte_workflow_v2.yml            # Example generated Flyte workflow spec v2
...
│   │   ├── main.py                            # Orchestrates extract pipeline via Flytekit (@task/@workflow) – replace Ray Workflows here
...
│   └── dynamic_FlyteWorkflow_generator.py     # Generates Flyte workflow definitions/manifests for extract-load (renamed from RayJob generator)
│
...
│   │   ├── dp_flyte_workflow_v1.yml            # Example generated Flyte workflow spec v1
│   │   └── dp_flyte_workflow_v2.yml            # Example generated Flyte workflow spec v2
...
│   │   ├── main.py                            # Orchestrates full preprocessing pipeline via Flytekit (@task/@workflow) instead of Ray Workflows
...
│   └── dynamic_FlyteWorkflow_generator.py     # Generates Flyte workflow definitions for data preprocessing
│
├── embedding                                  # Embedding pipeline code
│   ├── generated                              # Generated manifests for embedding pipeline
│   │   ├── em_flyte_workflow_v1.yml            # Example generated Flyte workflow spec v1
│   │   └── em_flyte_workflow_v2.yml            # Example generated Flyte workflow spec v2
...
│   │   ├── main.py                            # Entry-point for embedding tasks; converted to Flytekit orchestration
...
│   └── dynamic_FlyteWorkflow_generator.py     # Generates Flyte workflow definitions for embedding
│
...
│   │   ├── main.py                            # Entry-point for Qdrant ingestion via Flyte tasks/workflows instead of Ray
...
│   ├── dynamic_FlyteWorkflow_generator.py     # Generates Flyte workflow definitions for fine-tuning
│   └── fine_tune.py                           # Script to fine-tune a model via Qlora/DeepSpeed and save in S3
│
...
│   │   ├── dynamic_FlyteWorkflow_generator.py # Generates Flyte workflow definitions for RAG orchestration
...
│   │   ├── dynamic_FlyteWorkflow_generator.py # Generates Flyte workflow definitions for evaluation pipeline
│   │   └── modules/
│   │       ├── __init__.py                    # Marks modules as a Python package
...
│   │   │   ├── dynamic_FlyteWorkflow_generator.py # Generates Flyte workflow definitions for frontend CI/CD if needed
...
│   │   │   ├── dynamic_FlyteWorkflow_generator.py # Generates Flyte workflow definitions for any backend jobs/orchestrations
